...
<form action="contactus_insert.php"" method="POST" >
  <div class="container">
    ...
    <input type="number" placeholder="Enter Phone Number" name="phoneno" id="phoneno" required>
    <label for="message"><b>Message</b></label>
	<textarea type="text" placeholder="Enter Message" name="message" id="message"  required></textarea>
    
   

    <button type="submit" class="registerbtn" value="Submit" name="Submit">Contact Us</button>
  </div>
